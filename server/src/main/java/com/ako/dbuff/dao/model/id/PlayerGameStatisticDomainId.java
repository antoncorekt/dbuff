 ...
 * 
 * Uses matchId + playerSlot instead of matchId + playerId because:
 * - Anonymous players have null accountId (stored as -1)
 * - Multiple anonymous players in the same match would have the same playerId (-1)
...
public class PlayerGameStatisticDomainId implements Serializable {
   ...
   * Slots 0-4 are Radiant, slots 5-9 (or 128-132) are Dire.
   */
