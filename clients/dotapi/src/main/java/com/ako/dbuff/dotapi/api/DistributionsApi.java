...
import com.ako.dbuff.dotapi.model.DistributionsResponse;
...
public class DistributionsApi {
   ...
   */
  public DistributionsResponse getDistributions() throws ApiException {
    return getDistributionsWithHttpInfo().getData();
  }
   ...
   */
  public ApiResponse<DistributionsResponse> getDistributionsWithHttpInfo() throws ApiException {
    String localVarAccept = apiClient.selectHeaderAccept("application/json; charset=utf-8");
    String localVarContentType = apiClient.selectHeaderContentType();
    GenericType<DistributionsResponse> localVarReturnType = new GenericType<DistributionsResponse>() {};
    return apiClient.invokeAPI("DistributionsApi.getDistributions", "/distributions", "GET", new ArrayList<>(), null,
